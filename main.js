...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const load0 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/video1.mp4');
  ...
  const load1 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/video2.mp4');
  ...
  const load2 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/video3.MOV');
  ...
  const Start = async () => {
    ...
    mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: './assets/targets/targets_adachi.mind',
    });
